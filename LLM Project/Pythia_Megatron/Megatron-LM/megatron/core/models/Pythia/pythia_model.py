...
from megatron.core.transformer.transformer_config_tai import TransformerConfig
from megatron.core.utils_tai import make_tp_sharded_tensor_for_checkpoint
