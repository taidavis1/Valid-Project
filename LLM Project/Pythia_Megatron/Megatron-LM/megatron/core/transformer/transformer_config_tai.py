...
from ..utils_tai import init_method_normal, scaled_init_method_normal , small_init_method , wang_init_method
...
class TransformerConfig(ModelParallelConfig):
    ...
    def __post_init__(self):
        ...
        if self.init_method == 'small_init_method':
            self.init_method = small_init_method(self.init_method_std , self.hidden_size)
        ...
        if self.output_layer_init_method == 'wang_init':
            self.output_layer_init_method = wang_init_method(
